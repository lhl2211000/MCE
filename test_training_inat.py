...
class iNaturalistDataLoader(DataLoader):
    ...
    """
    def __init__(self, data_dir, batch_size, shuffle=True, num_workers=0, training=True, balanced=False, retain_epoch_size=True, train_txt= './data_txt/iNaturalist/iNaturalist18_train.txt',
